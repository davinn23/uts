...
export default function Home() {
  const [searchTitle, setSearchTitle] = useState("programming")
  const [page, setPage] = useState(1)

  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 px-4 py-6 transition-colors duration-500">
      <HomeWithPagination
